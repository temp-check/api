...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference("Temperature.count") do
      post temperatures_url, params: { temperature: { forecast: @temperature.forecast, postal_code_id: @temperature.postal_code_id } }, as: :json
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { forecast: @temperature.forecast, postal_code_id: @temperature.postal_code_id } }, as: :json
    assert_response :success
  end
